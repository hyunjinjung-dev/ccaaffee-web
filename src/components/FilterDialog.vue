  ...
  <v-card>
    ...
    <v-card-text :class="{ marginZero: breakPointXs, maxHeight: !breakPointXs }">
      <v-list subheader>
        ...
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title>
              ...
              <v-switch style="display:inline-block;" v-model="visitOptionsSwitch" dense></v-switch>
            </v-list-item-title>
            <v-list-item-subtitle>
              <v-expand-transition>
        ...
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title>거리 <span class="body-2">(기본 500m 적용)</span></v-list-item-title>
            <v-list-item-subtitle>
              <v-slider
          ...
          <v-list-item-content>
            ...
            <v-list-item-subtitle>
              <v-chip-group
                ...
                active-class="primary primary--text"
              >
                <v-chip small outlined v-for="(tag, index) in OfferTags" :key="index" :value="tag">
                  {{ tag }}
                </v-chip>
              </v-chip-group>
            </v-list-item-subtitle>
          ...
          <v-list-item-content>
            ...
            <v-list-item-subtitle>
              <v-chip-group
                ...
                active-class="primary primary--text"
              >
                <v-chip small outlined v-for="(tag, index) in policyTags" :key="index" :value="tag">
                  {{ tag }}
                </v-chip>
              </v-chip-group>
            </v-list-item-subtitle>
          ...
          <v-list-item-content>
            ...
            <v-list-item-subtitle>
              <v-chip-group
                ...
                active-class="primary primary--text"
              >
                <v-chip small outlined v-for="(tag, index) in themeTags" :key="index" :value="tag">
                  {{ tag }}
                </v-chip>
              </v-chip-group>
            </v-list-item-subtitle>
