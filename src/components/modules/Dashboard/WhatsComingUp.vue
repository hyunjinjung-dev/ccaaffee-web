    ...
    <v-card-text class="pa-0">
      <v-list two-line>
        <v-list-item avatar>
          ...
          <v-list-item-content>
            <v-list-item-title>John's 360 appraisal will need completing</v-list-item-title>
            <v-list-item-sub-title class="info--text">in 1 week</v-list-item-sub-title>
          </v-list-item-content>
        </v-list-item>
        <v-list-item avatar>
          <v-list-item-avatar>
          ...
          <v-list-item-content>
            ...
            <v-list-item-sub-title class="info--text">in 3 weeks</v-list-item-sub-title>
          </v-list-item-content>
        </v-list-item>
      </v-list>
    </v-card-text>
